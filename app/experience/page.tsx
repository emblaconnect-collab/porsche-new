...
const events = [
  { title: "Porsche Driving Experience", location: "Nürburgring, Germany", date: "Mar – Nov 2024", description: "Master the legendary Green Hell with professional Porsche instructors at your side.", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCPlS1UxhRJg3OwO6a1gNGiuKH19iqi0EBopXITPkzzwgS8wDvFUfBvCe-l_ROAPDk18OtJM3NhUTO9VK1olWc1Edal8Xsrdz64TQsqSB_IfdVzRkVuqV-xs2Yet0igJ78Z7CKFeLrUAwSrphfhcFtV86SzTZcXab1ZNiK26IUPlGA9WtcWmUuQ88P-8_TvcoFa6UdRy0hHQ-os0KlQ7BogkgGRXKHEmgB4wDqQobqnyR_n_c_mFuetZp1bpxeYPaeYzb00UvugAuNP" },
  { title: "911 Exclusive Test Drive", location: "Your Local Dealer", date: "Available Now", description: "Book a private test drive of the 911 Turbo S. Experience 640hp on the road.", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCS7XKcxEjjdebtM9H8E8c2yvCM_057X7WpPf5yQNbawz3k_7ZxrIsTiWzvnhj-qrL8UglchQi9sCjRI22O2B_nS4ZR0zljkqp434zg0_6_-2pN6Jlr0IGbWYdGwc7U2jsGmlu2FkfA4NTWBaLh3yOsIBlFj1duL4c9HqqN4OP5SrtdxZBUzM54_Dhv790B9gD4bjIx8T-QYDyZAbLjb2YfplEIR582hdFjGQL67VV57IeSkYxIOj2G4Iaa_SfLS8y8DLWzejRpfWz3" },
  { title: "Taycan Electric Journey", location: "Multiple Routes", date: "Year-round", description: "Discover the future of performance. A curated long-distance route in the all-electric Taycan.", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuANRJ6ci2F2yzYVQ-KJ3stoeMwlteQ1MoLetNUAngZpTv9kF_aIEKXu7-BB4vzZ_hDjAwE2kAgUYayG4tN-Z_LMilSEZNHmtcnFgysCgOR8sHjif1eG4qaRw_Q9uCgg2u6lrdHOPiJmyW7YALPhycstOTLnS_eV7FhG1BDF-AVbnosjtZ7wYArj843_u9ZSUoebcpvlRChBfA32IJD5itaRpwoAC6A6tD4uYRdIY2BGV0FEEKmzwlmX6EDM9N8-SPav9DqN7Gedd0dL" },
];
    ...
    <div className="min-h-screen bg-[#060606] pt-28 pb-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} className="mb-20">
          <span className="text-[10px] tracking-[0.5em] text-[#d5001c] uppercase font-bold block mb-4">Beyond Driving</span>
          <h1 className="font-display text-5xl md:text-7xl italic text-white mb-6" style={{ letterSpacing: "-0.02em" }}>The Experience</h1>
          <p className="text-white/40 max-w-xl text-sm leading-relaxed tracking-wide">
            From track days to exclusive test drives. Live the Porsche lifestyle beyond the showroom.
          </p>
        </motion.div>
