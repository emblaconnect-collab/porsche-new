      ...
      <div className="sticky top-0 w-full h-screen overflow-hidden bg-[#060606]">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-6">
          ...
          <motion.span
            ...
            style={{ color: "#c9a84c" }}
          >
            Engineered for Passion · Since 1948
          </motion.span>
          ...
          >
            There is No
            <br />
            <span style={{ color: "#e8d5a3" }}>Substitute.</span>
          </motion.h1>
          ...
          >
            Every curve engineered. Every moment amplified. Every drive unforgettable.
          </motion.p>
          ...
          >
            {/* Botão primário — dourado, redondo */}
            <Link href="/showroom">
              <motion.button
            ...
            {/* Botão secundário — borda dourada, redondo */}
